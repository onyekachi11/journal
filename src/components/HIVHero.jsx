        ...
        <motion.div variants={textVariant()} className="">
          <p
            className="text-main md:text-[20px] ss:text-[17px] 
                    ...
                    text-center"
          >
            Dedicated to advancing knowledge in the field of Human
            Immunodeficiency Virus (HIV), EJHIV focuses on research, prevention,
            and treatment strategies. Navigate through studies that contribute
            to the global effort to combat HIV, exploring innovative approaches,
            breakthroughs, and critical insights into the multifaceted
            dimensions of this public health challenge.
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        <p
          className="text-main md:text-[18px] ss:text-[17px] 
                text-[15px] font-bold"
        >
          EJHIV: <span className="font-light">Elite Journal of HIV</span>
        </p>
